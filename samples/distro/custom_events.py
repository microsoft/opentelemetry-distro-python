...
logger.info("Hello World!", extra={"microsoft.custom_event.name": "test-custom-event-1", "additional_attrs": "genai"})

# You can also populate fields like client_Ip with attribute `client.address`
logger.info(
    "This entry will have a custom client_Ip",
    extra={"microsoft.custom_event.name": "test-custom-event-2", "client.address": "197.168.1.1"},
)
