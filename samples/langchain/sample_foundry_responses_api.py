...
def main() -> None:
    ...
    llm = ChatOpenAI(
        ...
        # Langchain documentation - https://reference.langchain.com/python/langchain-openai/chat_models/base/BaseChatOpenAI/include_response_headers # pylint: disable=line-too-long
