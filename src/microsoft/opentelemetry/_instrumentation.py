...
"""Instrumentation dependency-conflict detection.

Vendored from `opentelemetry-python-contrib` while the upstream API is
experimental. Provides :func:`get_dist_dependency_conflicts` which checks
whether an instrumentor's required library versions are satisfied before
activating it.
"""
