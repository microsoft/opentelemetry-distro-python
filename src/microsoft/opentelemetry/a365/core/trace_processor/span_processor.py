...
from microsoft.opentelemetry.a365.core.constants import GEN_AI_OPERATION_NAME_KEY, INVOKE_AGENT_OPERATION_NAME
from microsoft.opentelemetry.a365.core.trace_processor.util import COMMON_ATTRIBUTES, INVOKE_AGENT_ATTRIBUTES
