...
from microsoft.opentelemetry.a365.core import constants as consts
...
COMMON_ATTRIBUTES = [
    ...
    consts.GEN_AI_AGENT_BLUEPRINT_ID_KEY,  # microsoft.opentelemetry.a365.agent.blueprint.id
    consts.GEN_AI_AGENT_AUID_KEY,  # microsoft.agent.user.id
    consts.GEN_AI_AGENT_PLATFORM_ID_KEY,  # microsoft.opentelemetry.a365.agent.platform.id
...
INVOKE_AGENT_ATTRIBUTES = [
    ...
    consts.GEN_AI_CALLER_AGENT_ID_KEY,  # microsoft.opentelemetry.a365.caller.agent.id
    consts.GEN_AI_CALLER_AGENT_NAME_KEY,  # microsoft.opentelemetry.a365.caller.agent.name
    consts.GEN_AI_CALLER_AGENT_USER_ID_KEY,  # microsoft.opentelemetry.a365.caller.agent.user.id
    consts.GEN_AI_CALLER_AGENT_EMAIL_KEY,  # microsoft.opentelemetry.a365.caller.agent.user.email
    consts.GEN_AI_CALLER_AGENT_APPLICATION_ID_KEY,  # microsoft.opentelemetry.a365.caller.agent.blueprint.id
    consts.GEN_AI_CALLER_AGENT_PLATFORM_ID_KEY,  # microsoft.opentelemetry.a365.caller.agent.platform.id
    consts.GEN_AI_CALLER_AGENT_VERSION_KEY,  # microsoft.opentelemetry.a365.caller.agent.version
