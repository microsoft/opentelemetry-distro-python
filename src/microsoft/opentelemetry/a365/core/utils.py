...
def warn_if_hosting_missing(target_logger: logging.Logger, *modules: str) -> None:
    """Log :data:`HOSTING_INSTALL_HINT` on *target_logger* if any *modules* can't be imported."""
    ...
    for name in modules:
        try:
            ...
            target_logger.warning(HOSTING_INSTALL_HINT)
            return
