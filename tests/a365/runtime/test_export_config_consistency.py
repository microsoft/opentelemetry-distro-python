...
class TestExportConfigConsistency(unittest.TestCase):
    ...
    def test_export_url_standard_path_structure(self):
        ...
        expected = f"{self.EXPECTED_ENDPOINT}{self.EXPECTED_STANDARD_PATH.format(tid='t1', aid='a1')}?api-version=1"
        self.assertEqual(
            url,
            expected,
    ...
    def test_export_url_s2s_path_structure(self):
        ...
        expected = f"{self.EXPECTED_ENDPOINT}{self.EXPECTED_S2S_PATH.format(tid='t1', aid='a1')}?api-version=1"
        self.assertEqual(
            url,
            expected,
