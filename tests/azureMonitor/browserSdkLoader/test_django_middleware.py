...
class TestDjangoMiddleware(unittest.TestCase):
    ...
    @patch("microsoft.opentelemetry._azureMonitor._browser_sdk_loader.django_middleware.DJANGO_AVAILABLE", True)
    def test_middleware_initialization_django_available(self):
        """Test middleware initialization when Django is available."""
        from microsoft.opentelemetry._azureMonitor._browser_sdk_loader.django_middleware import (
    ...
    @patch("microsoft.opentelemetry._azureMonitor._browser_sdk_loader.django_middleware.DJANGO_AVAILABLE", False)
    @patch("microsoft.opentelemetry._azureMonitor._browser_sdk_loader.django_middleware._logger")
    def test_middleware_initialization_django_not_available(self, mock_logger):
        ...
        ApplicationInsightsWebSnippetMiddleware(self.get_response_mock)
    ...
    def test_configure_with_dict_config(self):
        ...
        middleware = ApplicationInsightsWebSnippetMiddleware(self.get_response_mock)
        config_dict = {"enabled": True, "connection_string": self.connection_string}
    ...
    def test_process_response_with_content_encoding(self):
        ...
        with (
            ...
            mock_should_inject.assert_called_once_with("GET", "text/html", original_content, "gzip")
