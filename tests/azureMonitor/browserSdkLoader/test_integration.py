...
from microsoft.opentelemetry._azureMonitor._constants import BROWSER_SDK_LOADER_CONFIG_ARG
...
class TestBrowserSDKIntegration(unittest.TestCase):
    ...
    @patch("microsoft.opentelemetry._azureMonitor._configure.setup_snippet_injection")
    ...
    def test_configure_azure_monitor_with_browser_sdk_dict(self, mock_setup_snippet):
        ...
        args, _kwargs = mock_setup_snippet.call_args
        config_arg = args[0]
    ...
    @patch("microsoft.opentelemetry._azureMonitor._browser_sdk_loader.setup_snippet_injection")
    ...
    def test_configure_azure_monitor_uses_env_connection_string_for_browser_loader(self, mock_setup_snippet):
        ...
        from microsoft.opentelemetry._azureMonitor._configure import _setup_browser_sdk_loader
        from microsoft.opentelemetry._azureMonitor._utils.configurations import _get_configurations
    ...
    def test_browser_sdk_config_from_dict_conversion(self):
        ...
        config_dict = {"enabled": False, "connection_string": "test_connection_string"}
