...
from microsoft.azureMonitor._constants import LOGGER_NAME_ENV_ARG, LOGGING_FORMAT_ENV_ARG
...
class TestConfigurations(TestCase):
    ...
    @patch(
        "microsoft.azureMonitor._utils.configurations._PREVIEW_INSTRUMENTED_LIBRARIES",
    ...
    @patch("microsoft.azureMonitor._utils.configurations._logger")
