...
class TestConfigurator(TestCase):
    @patch("microsoft.opentelemetry._azure_monitor._autoinstrumentation.configurator.super")
    @patch("microsoft.opentelemetry._azure_monitor._autoinstrumentation.configurator.ApplicationInsightsSampler")
    @patch(
        "microsoft.opentelemetry._azure_monitor._autoinstrumentation.configurator._is_attach_enabled", return_value=True
    )
    @patch("microsoft.opentelemetry._azure_monitor._autoinstrumentation.configurator.AzureDiagnosticLogging")
    ...
    @patch("microsoft.opentelemetry._azure_monitor._autoinstrumentation.configurator.ApplicationInsightsSampler")
    @patch(
        "microsoft.opentelemetry._azure_monitor._autoinstrumentation.configurator._is_attach_enabled",
        return_value=False,
    )
    @patch("microsoft.opentelemetry._azure_monitor._autoinstrumentation.configurator.AzureDiagnosticLogging")
