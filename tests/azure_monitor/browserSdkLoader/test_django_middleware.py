...
class TestDjangoMiddleware(unittest.TestCase):
    ...
    @patch("microsoft.opentelemetry._azure_monitor._browser_sdk_loader.django_middleware.DJANGO_AVAILABLE", True)
    ...
    @patch("microsoft.opentelemetry._azure_monitor._browser_sdk_loader.django_middleware.DJANGO_AVAILABLE", False)
    @patch("microsoft.opentelemetry._azure_monitor._browser_sdk_loader.django_middleware._logger")
