...
from microsoft.opentelemetry._azure_monitor._constants import BROWSER_SDK_LOADER_CONFIG_ARG
...
class TestBrowserSDKIntegration(unittest.TestCase):
    ...
    @patch("microsoft.opentelemetry._azure_monitor._configure.setup_snippet_injection")
    ...
    @patch("microsoft.opentelemetry._azure_monitor._browser_sdk_loader.setup_snippet_injection")
    ...
    def test_configure_azure_monitor_uses_env_connection_string_for_browser_loader(self, mock_setup_snippet):
        ...
        from microsoft.opentelemetry._azure_monitor._configure import _setup_browser_sdk_loader
