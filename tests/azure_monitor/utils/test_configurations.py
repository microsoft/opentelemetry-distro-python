...
from microsoft.opentelemetry._azure_monitor._constants import LOGGER_NAME_ENV_ARG, LOGGING_FORMAT_ENV_ARG
...
class TestConfigurations(TestCase):
    ...
    @patch(
        "microsoft.opentelemetry._azure_monitor._utils.configurations._PREVIEW_INSTRUMENTED_LIBRARIES",
    ...
    @patch("microsoft.opentelemetry._azure_monitor._utils.configurations._logger")
